(function () {
    ...
    if (false) {
        require(window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.3a405.js');
        var prevPipe = cc.loader.md5Pipe || cc.loader.assetLoader;
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.3a405.js';
